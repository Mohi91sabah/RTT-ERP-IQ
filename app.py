...
if role == "Admin":
    menu_options = ["Dashboard", "User Management", "Vendors", "Items", "Create PR", "PR Approvals", "Create RFQ", "Add Quotation", "Compare Quotations", "Create PO", "PO Approvals", "Register Invoice", "Register Payment", "Accounts Payable", "Reports"]
elif role == "PR User":
